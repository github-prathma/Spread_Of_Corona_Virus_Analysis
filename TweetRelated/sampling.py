...
Sample by days
'''
# # hr indicates the dataset in: https://github.com/echen102/COVID-19-TweetIDs.git
# hr = "/Volumes/TOSHIBA SSD/PycharmProjects/COVID-19/COVID-19-TweetIDs-master/2020-"
# hw = "COVID-19-TweetIDs-samples/"
...
'''
head = "COVID-19-TweetIDs-samples/by day/"
nums = []
for month in ["01", "02", "03"]:
    for day in range(1, 32):
        print("===== Read date: " + month + "-" + str(day).zfill(2) + " =======")
...
plt.savefig("figures/by_day.eps",
            bbox_inches = 'tight')
plt.show()
...
'''
head = "COVID-19-TweetIDs-samples/by hour/"
nums = []
for month in ["01", "02", "03"]:
    for day in range(1, 32):
        print("===== Read date: " + month + "-" + str(day).zfill(2) + " =======")
...
plt.ylabel("# Sampled Tweets")
plt.savefig("figures/by_hour.eps",
            bbox_inches = 'tight')
plt.show()
